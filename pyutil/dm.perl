...
$w1 = 0.15;
$w2 = 0.05;
print "152:",formulate_query("angular cheilitis", "sd", $w0, $w1, $w2 ) . "\n";
print "154:",formulate_query("figs", "sd", $w0, $w1, $w2 ) . "\n";
print "156:",formulate_query("university of phoenix", $w0, $w1, $w2 ) . "\n";
print "158:",formulate_query("septic system design", $w0, $w1, $w2 ) . "\n";
print "160:",formulate_query("grilling", $w0, $w1, $w2 ) . "\n";
print "162:",formulate_query("dnr", $w0, $w1, $w2 ) . "\n";
print "164:",formulate_query("hobby stores", $w0, $w1, $w2 ) . "\n";
print "166:",formulate_query("computer programming", $w0, $w1, $w2 ) . "\n";
print "168:",formulate_query("lipoma", $w0, $w1, $w2 ) . "\n";
print "170:",formulate_query("scooters", $w0, $w1, $w2 ) . "\n";
print "172:",formulate_query("becoming a paralegal", $w0, $w1, $w2 ) . "\n";
print "174:",formulate_query("rock art", $w0, $w1, $w2 ) . "\n";
print "176:",formulate_query("weather strip", $w0, $w1, $w2 ) . "\n";
print "178:",formulate_query("pork tenderloin", $w0, $w1, $w2 ) . "\n";
print "180:",formulate_query("newyork hotels", $w0, $w1, $w2 ) . "\n";
print "182:",formulate_query("quit smoking", $w0, $w1, $w2 ) . "\n";
print "184:",formulate_query("civil right movement", $w0, $w1, $w2 ) . "\n";
print "186:",formulate_query("unc", $w0, $w1, $w2 ) . "\n";
print "188:",formulate_query("internet phone service", $w0, $w1, $w2 ) . "\n";
print "190:",formulate_query("brooks brothers clearance", $w0, $w1, $w2 ) . "\n";
print "192:",formulate_query("condos in florida", $w0, $w1, $w2 ) . "\n";
print "194:",formulate_query("designer dog breeds", $w0, $w1, $w2 ) . "\n";
print "196:",formulate_query("sore throat", $w0, $w1, $w2 ) . "\n";
print "198:",formulate_query("indiana state fairgrounds", $w0, $w1, $w2 ) . "\n";
print "200:",formulate_query("ontario california airport", $w0, $w1, $w2 ) . "\n";
